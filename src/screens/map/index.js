        ...
        <Container style={{backgroundColor:'#567afc'}}>
          ...
          <Content style={styles.mainContainer}>
            ...
            <View style={{height:'9%',width:'100%',position:'absolute',bottom:0,flexDirection:'row',backgroundColor:'white'}}>
              ...
              <TouchableOpacity onPress={() => {this.props.navigation.navigate("Map")}} style={{flex:1,justifyContent:'center',alignItems:'center'}}><Text ><Icon type="Ionicons" style={{fontSize:40,color:'#567afc'}} name="map" /></Text></TouchableOpacity>
